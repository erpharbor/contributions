...
var pyutil = require('web.py_utils');
var session = require('web.session');

var original_pyeval = pyutil.eval;
var original_ensure_evaluated = pyutil.ensure_evaluated;
var py = window.py;
...
function eval_contexts (contexts, evaluation_context) {
    evaluation_context = _.extend(pyutil.context(), evaluation_context || {});
...
pyutil.eval = domain_field_pyeval;
pyutil.ensure_evaluated = ensure_evaluated;
pyutil.sync_eval_domains_and_contexts = sync_eval_domains_and_contexts;
